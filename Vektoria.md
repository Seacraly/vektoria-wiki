...
```leaflet  
id: Vektoria1 ### Must be unique with no spaces  
image: [[Vektoria.jpg]] ### Link to the map image file. Do not add a ! in front of the image  
bounds: [[0,0], [768, 1024]] ### Size of the map in px Height_y, Width_x. Ignore 0,0  
height: 768px ### Size of the leaflet embed in px on your screen  
